...
//10
  ...
  static TextStyle gilroyW7S12primaryColor = gilroyW7S24darkBlack.copyWith(
      color: ColorUtils.primaryColor, fontSize: 12.sp);
...
//12 dark black
  ...
  static TextStyle GorditaW7S10white =
      GorditaW7S12darkBlack.copyWith(color: ColorUtils.white, fontSize: 10.sp);
//12
  ...
  static TextStyle GorditaW7S15white =
      GorditaW7S15darkBlack.copyWith(color: ColorUtils.white);
//change
  ...
  static TextStyle GorditaW5S10primarycolor =
      GorditaW5S10lightBlack.copyWith(color: ColorUtils.primaryColor);

  static TextStyle GorditaW5S10grey =
      GorditaW5S10primarycolor.copyWith(color: ColorUtils.grey);
  ...
  static TextStyle GorditaW5S12accent =
      GorditaW5S12darkBlack.copyWith(color: ColorUtils.accent);
  ...
  static TextStyle GorditaW4S10lightBlack =
      GorditaW4S10black.copyWith(fontSize: 10.sp, color: ColorUtils.lightBlack);
