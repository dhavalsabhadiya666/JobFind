...
import 'package:teleport/view/createnewjob/create_job3_screen.dart';
...
class CreateJob2Screen extends StatefulWidget {
  const CreateJob2Screen({Key? key}) : super(key: key);

  @override
  State<CreateJob2Screen> createState() => _CreateJob2ScreenState();
}

class _CreateJob2ScreenState extends State<CreateJob2Screen> {
              ...
              child: FloatingActionButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => CreateJob3Screen()));
                },
